...
class TaskListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_list" do
    assert_difference('TaskList.count') do
      post task_lists_url, params: { task_list: { done: @task_list.done, note: @task_list.note, priority: @task_list.priority, task: @task_list.task, whenDue: @task_list.whenDue } }
    end
  ...
  test "should update task_list" do
    patch task_list_url(@task_list), params: { task_list: { done: @task_list.done, note: @task_list.note, priority: @task_list.priority, task: @task_list.task, whenDue: @task_list.whenDue } }
